...
CALLED_TO_TARGET = "Called to Target"
...
HUNTER_MINELAYING = "MINELAYING"
HUNTER_PLAN = "PLAN SURFACE SHIPS"
HUNTER_UAV = "UAV"
HUNTER_AIRCRAFT = "MANNED AIRCRAFT"
HUNTER_MISSILE = "MISSILE"
HUNTER_TYPES = [HUNTER_CCG, HUNTER_MSA, HUNTER_PAFMM, HUNTER_SUBMARINE, HUNTER_MINELAYING,
...
COALITION_ALL_TYPES = [COALITION_TW_ESCORT, COALITION_US_ESCORT, COALITION_JP_ESCORT,
                       COALITION_TW_MERCHANT, COALITION_US_MERCHANT, COALITION_JP_MERCHANT]
COALITION_ACTIVE_TYPES = [COALITION_TW_ESCORT, COALITION_US_ESCORT, COALITION_JP_ESCORT]
